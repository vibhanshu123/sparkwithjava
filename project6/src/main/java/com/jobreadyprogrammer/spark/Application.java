...
public class Application {
	...
	public static void main(String[] args) {
		...
		SparkSession spark = SparkSession.builder()
		 ...
		 String redditFile = "s3n://spark-data-learning/Reddit-2007-small.json";
		 
//		 String redditFile = "/Users/vibhanshu/Desktop/kafka/SparkCourse/data/Reddit-2007-small.json"; 
...
//			wordsDf = wordsDf.except(boringWordsDf); // <-- This won't work because it removes duplicate words!!
		    ...
		    //leftanti is useful where it does left join and also does not remove duplicates
